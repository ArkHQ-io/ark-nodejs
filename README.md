...
[![NPM version](<https://img.shields.io/npm/v/ark.svg?label=npm%20(stable)>)](https://npmjs.org/package/ark) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/ark)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/ark-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install ark`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/ark-typescript/issues) with questions, bugs, or suggestions.
