...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22ark-email-mcp%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fark-mcp.stlmcp.com%22%2C%22headers%22%3A%7B%22x-ark-api-key%22%3A%22My%20API%20Key%22%7D%7D)
...
```
claude mcp add ark_email_mcp_api --header "x-ark-api-key: My API Key" --transport http https://ark-mcp.stlmcp.com
```
