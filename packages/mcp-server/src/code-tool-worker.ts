...
import { Ark, ClientOptions } from 'ark-email';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Ark)`
    : `const run: (${functionSource.client}: Ark) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.emails.retrieveDeliveries',
    'client.emails.retry',
    'client.emails.send',
    'client.emails.sendBatch',
    'client.emails.sendRaw',
    'client.logs.list',
    'client.logs.retrieve',
    'client.usage.export',
    ...
    'client.tenants.credentials.create',
    'client.tenants.credentials.delete',
    'client.tenants.credentials.list',
    'client.tenants.credentials.retrieve',
    'client.tenants.credentials.update',
    'client.tenants.domains.create',
    'client.tenants.domains.delete',
    'client.tenants.domains.list',
    'client.tenants.domains.retrieve',
    'client.tenants.domains.verify',
    'client.tenants.suppressions.create',
    'client.tenants.suppressions.delete',
    'client.tenants.suppressions.list',
    'client.tenants.suppressions.retrieve',
    'client.tenants.webhooks.create',
    'client.tenants.webhooks.delete',
    'client.tenants.webhooks.list',
    'client.tenants.webhooks.listDeliveries',
    'client.tenants.webhooks.replayDelivery',
    'client.tenants.webhooks.retrieve',
    'client.tenants.webhooks.retrieveDelivery',
    'client.tenants.webhooks.test',
    'client.tenants.webhooks.update',
    'client.tenants.tracking.create',
    'client.tenants.tracking.delete',
    'client.tenants.tracking.list',
    'client.tenants.tracking.retrieve',
    'client.tenants.tracking.update',
    'client.tenants.tracking.verify',
    'client.tenants.usage.retrieve',
    'client.tenants.usage.retrieveTimeseries',
    'client.platform.webhooks.create',
    'client.platform.webhooks.delete',
    'client.platform.webhooks.list',
    'client.platform.webhooks.listDeliveries',
    'client.platform.webhooks.replayDelivery',
    'client.platform.webhooks.retrieve',
    'client.platform.webhooks.retrieveDelivery',
    'client.platform.webhooks.test',
    'client.platform.webhooks.update',
  ],
